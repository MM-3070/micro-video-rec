...
class CliprecDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        #print(vid_id)
        clip_feature = torch.tensor(np.load('./fast_video_feature/'+str(int(vid_id))+'.npy'))  #tensor[num_clips,dim]
        ...
        #dataset类返回一个字典，每个interaction record返回包括:
        # tensor:[num_clips*num_frm,c,h,w]  
        # u_id  
        # clip_label